...
contract Token is Ownable, ERC20Capped {
    ...
    constructor() public ERC20("HyperUnity", "HUNI") ERC20Capped(1000000000 * 10**18) {
        uint256 cap = 1000000000 * 10**18;
        uint256 treasure = 50000000 * 10**18;
        uint256 dev = 50000000 * 10**18;
        uint256 collateral = 150000000 * 10**18;
        uint256 owner = 730000000 * 10**18;
